...
1. `git clone https://github.com/xiaoxiaobujidao/mtprotoproxy.git; cd mtprotoproxy;apt install python3-pip -y;pip3 install cryptography;screen python3 mtprotoproxy.py  `
